...
<form>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="nim" placeholder="J3C118062">
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Nama</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" name="nama" placeholder="Nurul Izza Farhana">
    </div>
   ...
   <br>
    ...
    <div class="form-check">
         ...
         <label><input type="checkbox" name="olahraga_fav[]" value="Bola Volly">Bola Volly</label><br>
         <label><input type="checkbox" name="olahraga_fav[]" value="Bersepeda">Bersepeda</label><br>
         <label><input type="checkbox" name="olahraga_fav[]" value="Berenang">Berenang</label><br>
