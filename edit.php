  ...
  <body>
   ...
   <br>
    ...
    <div class="form-check">
         ...
         <label><input type="checkbox" name="olahraga_fav[]" value="Bola Volly" 
         <?php if (in_array("Bola Volly", $dataor)) echo "checked";?> >Bola Volly</label><br>
         ...
         <label><input type="checkbox" name="olahraga_fav[]" value="Berenang" 
         <?php if (in_array("Berenang", $dataor)) echo "checked";?>>Berenang</label><br>

         <label><input type="checkbox" name="olahraga_fav[]" value="Esport" 
